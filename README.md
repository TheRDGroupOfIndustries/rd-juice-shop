# ![Juice Shop Logo](https://raw.githubusercontent.com/juice-shop/juice-shop/master/frontend/src/assets/public/images/JuiceShop_Logo_100px.png) RD Juice Shop
...
RD Juice Shop is probably the most modern and sophisticated insecure web application! It can be used in security
...
> [the _Running RD Juice Shop_ documentation](https://pwning.owasp-juice.shop/companion-guide/latest/part1/running.html).
...
Feel free to have a look at the latest version of RD Juice Shop:
...
RD Juice Shop officially supports the following versions of
...
RD Juice Shop comes with an official companion guide eBook. It will give you a complete overview of all
...
[Pwning RD Juice Shop](https://leanpub.com/juice-shop) is published under
...
[<img alt="Pwning RD Juice Shop cover" src="https://raw.githubusercontent.com/juice-shop/pwning-juice-shop/master/docs/modules/ROOT/assets/images/cover.jpg" width="200"/>](https://leanpub.com/juice-shop)
[<img alt="Pwning RD Juice Shop back cover" src="https://raw.githubusercontent.com/juice-shop/pwning-juice-shop/master/docs/modules/ROOT/assets/images/introduction/back.jpg" width="200"/>](https://leanpub.com/juice-shop)
...
Did you write a blog post, magazine article or do a podcast about or mentioning RD Juice Shop? Or maybe you held or
...
* On
  ...
  you can get variants of the RD Juice Shop logo as single stickers to decorate your laptop with. They can also print
...
tick the "Publicly list me as a supporter of RD Juice Shop" checkbox on the donation form. You can find our more
...
The RD Juice Shop Project Leaders are:
...
For a list of all contributors to the RD Juice Shop please visit our
...
RD Juice Shop and any contributions are Copyright © by Bjoern Kimminich & the RD Juice Shop contributors
2014-2025.
